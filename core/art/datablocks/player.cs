...
datablock ParticleData(PlayerSplashMist)
{
   ...
   spinRandomMin        = -90.0;
   spinRandomMax        = 500.0;
   textureName          = "core/art/textures/splash";
...
datablock ParticleData(PlayerFoamParticle)
{
   ...
   spinRandomMin        = -90.0;
   spinRandomMax        = 500.0;
   textureName          = "core/art/textures/millsplash01";
...
{
   textureName          = "core/art/textures/wake";
   dragCoefficient     = "0.0";
...
datablock SplashData(PlayerSplash)
{
   ...
   texture = "core/art/textures/millsplash01";
...
datablock PlayerData(LightBuilder)
{
   ...
   className = Armor;
   shapeFile = "~/art/shapes/Soldier/soldier_rigged.dae";
   cameraMaxDist = 3;
   computeCRC = false;
   ...
   debrisShapeName = "~/art/shapes/debris_player.dts";
   debris = playerDebris;
...
datablock PlayerData(LightMaleBuilder : LightMale)
{
